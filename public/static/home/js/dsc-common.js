		...
		if(eveval != 1){
			...
			$.ajax({
			   ...
			   success: function(data){
					...
					var	channels = $("*[ectype='channels_" + data.data.goods_class_id + "']"),
						subitems = $("*[ectype='subitems_" + data.data.goods_class_id + "']"),
						brands = $("*[ectype='brands_" + data.data.goods_class_id + "']");

                   channels.html("                     <div class=\"categorys-title\">\n" +
                       "                <strong>\n" +
                       "                                <a href=\"category.php?id=4\" target=\"_blank\">"+data.data.class_name+"</a>\n" +
                       "                                </strong>\n" +
                       "                            </div>");
                   var one='',two = '';
                   $.each(data.data.one_class, function (n, value) {
                   		$.each(value.two_class,function(k,v){
                            two +="<a href=\"category.php?id=1106\" target=\"_blank\">"+v.class_name+"</a>\n";
					   });
                       one += "<dl class=\"dl_fore1\">\n" +
                           "    <dt><a href=\"category.php?id=1105\" target=\"_blank\">"+value.class_name+"</a></dt>\n" +
                           "    <dd>\n" +
                           two+
                           "            </dd>\n" +
                           "</dl>";
