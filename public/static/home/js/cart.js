...
function addToCartShowDiv(goodsId, script_name,goods_recommend,parentId)
{
    ...
    if($(".goods_info_attr").length > 0){
        ...
        Ajax.call('/home/details/goods_cart', 'goods=' + $.toJSON(goods), addToCartShowDivResponse, 'POST', 'JSON');
    }
}
...
function addToCart(goodsId, parentId,event,obj,divId,store_id,end_time,store_mobile)
{
    ...
    if($(".goods_info_attr").length > 0){
        ...
        // Ajax.call('/home/details/cart_list', 'goods=' + $.toJSON(goods), addToCartResponse, 'POST', 'JSON');
        window.open("/home/details/cart_list?goods_id="+goodsId+'&number='+number);
    }
}
