...
function userLogin()
{
	...
	Ajax.call( 'login/login_home', 'username=' + username.val()+'&password='+password.val()+remember_string+'&captcha='+captcha.val()+'&back_act='+back_act, return_login , 'POST', 'JSON');
}
